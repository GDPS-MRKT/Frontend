...
<style>
	...
	.logo:after {
		...
		--border-padding: 4px;
		--border-size: calc(var(--m3-shape-small) + var(--border-padding));
	...
	.logo:before {
		transform: translate(calc(var(--border-padding) * -1), calc(var(--border-padding) * -2 - 5px));
	}
